<?php
	...
	function fcwp_showButton() {
		if(fcwp_checkPage()) {
			echo "<a href='javascript:void(0)' id='fcwp_button' class='button'><img height='20' width='30' src='".plugins_url('assets/images/fc.png', __FILE__)."'>&nbsp;Add Chart</a>";
		}
	}
	...
	function fcwp_getChart() {
		...
		if(isset($_POST['chartDataType'])&&sanitize_text_field($_POST['chartDataType'])!="jsonurl"&&sanitize_text_field($_POST['chartDataType'])!="xmlurl") {
	        ...
	        $fcwp_chart = new fcwp_FusionCharts(
	            ...
	            sanitize_text_field($_POST['chartWidthUnit']), 
	            sanitize_text_field($_POST['chartHeight']), 
	            sanitize_text_field($_POST['chartHeightUnit']), 
